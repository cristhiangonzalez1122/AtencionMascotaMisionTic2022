...
export class MedicoSolicitudController {
  ...
  async find(
    ...
    return this.medicoRepository.solicituds(id).find(filter);
  }
  ...
  async create(
    ...
    return this.medicoRepository.solicituds(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.medicoRepository.solicituds(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.medicoRepository.solicituds(id).delete(where);
  }
}
